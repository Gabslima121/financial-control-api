...
import { PaymentMethodEnum, TransactionDomainDTO, TransactionStatusEnum } from "./dto";
...
export class TransactionsDomain {
  ...
  private constructor(params: TransactionDomainDTO) {
    this.transactionId = params.transactionId ? new UuidValueObject(params.transactionId) : new UuidValueObject();
    ...
    this.transactionStatus = params.transactionStatus ?? TransactionStatusEnum.PENDING;
  ...
  getTransactionId(): UuidValueObject { return this.transactionId; }
  getUser(): UserDomain | null { return this.user ?? null; }
  getCategory(): CategoriesDomain | null { return this.category ?? null; }
  getDestination(): PaymentDestinationsDomain | null { return this.destination ?? null; }

  getTransactionType(): CategoryTypeEnum { return this.transactionType; }
  getAmount(): number { return this.amount; }
  getPaymentMethod(): PaymentMethodEnum { return this.paymentMethod; }

  getInstallments(): number { return this.installments; }
  getCurrentInstallment(): number { return this.currentInstallment; }
  getParentTransactionId(): string | null { return this.parentTransactionId ?? null; }

  getDescription(): string | null { return this.description ?? null; }
  getTransactionStatus(): TransactionStatusEnum { return this.transactionStatus; }

  getTransactionDate(): Date { return this.transactionDate; }
  getDueDate(): Date | null { return this.dueDate ?? null; }
  getPaymentDate(): Date | null { return this.paymentDate ?? null; }
