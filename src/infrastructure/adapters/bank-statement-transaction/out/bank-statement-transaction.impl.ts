...
@Injectable()
export class BankStatementTransactionRepository
  implements BankStatementTransactionPort
{
  ...
  async findByFitId(
    accountId: string,
    fitId: string,
  ): Promise<BankStatementTransactionDomain | null> {
  ...
  async listByAccountId(
    accountId: string,
  ): Promise<BankStatementTransactionDomain[]> {
