...
export class BankStatementTransactionController {
    constructor(private readonly createBankStatementTransactionUseCase: CreateBankStatementTransactionUseCase) {}
    ...
    async create(@UploadedFile() file: Express.Multer.File, @Param('accountId') accountId: string) {
        if (!file) {
