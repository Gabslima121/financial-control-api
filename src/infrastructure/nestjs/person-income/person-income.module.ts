...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      ) => new CreatePersonIncomeUseCase(personIncomePort, findPersonById),
      inject: ['PersonIncomePort', FindPersonById],
    },
    {
      ...
      useFactory: (
        ...
        new GetPersonIncomeByPersonIdUseCase(personIncomePort, findPersonById),
      inject: ['PersonIncomePort', FindPersonById],
    },
    {
      provide: GetPersonIncomeByIdUseCase,
      useFactory: (personIncomePort: PersonIncomePort) =>
        new GetPersonIncomeByIdUseCase(personIncomePort),
      inject: ['PersonIncomePort'],
    },
  ],
  controllers: [PersonIncomeController],
  exports: [GetPersonIncomeByPersonIdUseCase, GetPersonIncomeByIdUseCase],
})
