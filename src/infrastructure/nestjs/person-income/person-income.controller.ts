...
export class PersonIncomeController {
    constructor(private readonly createPersonIncomeUseCase: CreatePersonIncomeUseCase) {}

    @Post()
    async createPersonIncome(@Body() createPersonIncomeDto: CreatePersonIncomeDTO) {
